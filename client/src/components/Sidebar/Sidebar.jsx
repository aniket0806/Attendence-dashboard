...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <div
      className={`w-64 bg-white shadow-lg h-screen fixed left-0 top-0 z-10 transition-transform duration-300 ${
                ...
                <div className="ml-7 mt-1">
                  <div
                    className={`py-2 px-3 text-sm cursor-pointer rounded ${
                      isSubMenuActive("/report/employee-attendance")
                        ? "text-orange-500 font-medium bg-orange-50"
                        : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                    }`}
                    onClick={() => navigate("/report/employee-attendance")}
                  >
                    Employees Attendance Report
                  </div>
                  <div
                    className={`py-2 px-3 text-sm cursor-pointer rounded ${
                      isSubMenuActive("/report/salary-preparation")
                        ? "text-orange-500 font-medium bg-orange-50"
                        : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                    }`}
                    onClick={() => navigate("/report/salary-preparation")}
                  >
            ...
            <div className="mb-1">
              ...
              {expandedMenu === "employeeDashboard" && (
                <div className="ml-7 mt-1">
                  <div
                    className={`py-2 px-3 text-sm cursor-pointer rounded ${
                      isSubMenuActive(`/employeedashboard/${user.username}`)
                        ? "text-orange-500 font-medium bg-orange-50"
                        : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                    }`}
                    onClick={() =>
